                    ...
                    <tbody>
                     ...
                     ?>
                      <tr>
                        ...
                        <td>
                        <a href="update_fournisseur.php?id=<?php echo $row['ID_Fournisseur'];?>"><i class="fas fa-edit"></i></a>
                        <a href="delete_fournisseur.php?id=<?php echo $row['ID_Fournisseur'];?>"><i class="fas fa-trash-alt" ></i></a>
                        </td>
                        </tr>
