...
<body class="sidebar-mini layout-fixed sidebar-closed sidebar-collapse" style="height: auto;">
  <div class="wrapper">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="form_matériel.php" method='POST'>
                <div class="card-body">
                  <div class="form-group">
                  <i class="fas fa-folder-open"></i>
                    <label for="exampleInputEmail1">Nom</label>
                    <input type="Nom" name='Nom_Materiel'class="form-control" id="exampleInputEmail1" placeholder="Entrez le nom">
                  </div>
                  <div class="form-group">
                  ...
                  <i class="fas fa-cart-arrow-down"></i>
                    ...
                    <input type="number" name='Quantite_livree' class="form-control" id="exampleInputEmail1" placeholder="">
                  </div>
                  <div class="form-group">
                  <i class="fas fa-newspaper"></i>
                    <label for="exampleInputEmail1">Référence</label>
                    <input type="texte" name='Reference' class="form-control" id="exampleInputEmail1" placeholder="Entrez la référence">
                  </div>
                  ...
                  ?>
                    <option value="<?php echo $row['ID_Fournisseur'];?>"><?php echo $row['Nom_Entreprise'];?></option>
                     <?php
                    }
                  ?>
                </select>
    ...
    if(!empty($_POST['Nom_Materiel']) && !empty($_POST['Date_entree']) && !empty($_POST['Quantite_livree']) && !empty($_POST['Reference']) && !empty($_POST['idFournisseur']))
    {    
        ...
        $idUtilisateur = 4;
                ...
                $insert_query = mysqli_query($conn,"INSERT INTO `materiel`(Nom_Materiel,Date_entree,Quantite_livree,Reference,ID_Fournisseur,ID_Utilisateur)
                 VALUES('$Nom_Materiel','$Date_entree','$Quantite_livree','$Reference','$idFournisseur','$idUtilisateur')");
