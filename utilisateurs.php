          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                    ...
                    <tbody>
                     ...
                     ?>
                      <tr>
                        ...
                        <td>
                        <a href="update_utilisateur.php?id=<?php echo $row['ID_Utilisateur'];?>"><i class="fas fa-edit"></i></a>
                        <a href="delete_utilisateur.php?id=<?php echo $row['ID_Utilisateur'];?>"><i class="fas fa-trash-alt" ></i></a>
                        </td>
                      </tr>
                      <?php
                      }
               ...
               ?>
               <a href="form_utilisateurs.php"><button type="button" class="btn btn-block btn-outline-info"><i class="fas fa-user-plus"></i></button></a>
                </div>
                <!-- /.card-body -->
              </div>
              <!-- /.card -->
