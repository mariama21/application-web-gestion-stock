          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="fournisseur.php">Fournisseurs</a></li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
               <div class="card">
                <div class="card-header">
                  <h3 class="card-title" >Formulaire des Fournisseurs</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body" >
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="form_fournisseurs.php" method='POST' >
                <div class="card-body">
                  ...
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input type="Nom_Entreprise" name='Nom_Entreprise'class="form-control" id="exampleInputEmail1" placeholder="Entrez le nom">
                  </div>
                  <div class="form-group">
                    ...
                    <input type="Pays" name='Pays'class="form-control" id="exampleInputEmail1" placeholder="Entrez le pays">
                  </div>
                  <div class="form-group">
                    ...
                    <input type="Contact" name='Contact' class="form-control" id="exampleInputEmail1" placeholder="Entrez le contact">
                  </div>
