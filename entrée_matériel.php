          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                ...
                $get_data = mysqli_query($conn,"SELECT * FROM `fournisseur` f, `materiel` m WHERE f.ID_Fournisseur=m.ID_Fournisseur");
                    ...
                    <?php
                     ...
                     ?>
                      <tr>
                        ...
                        <td><?php echo $row['Quantite_livree'];?></td>
                        <td><?php echo $row['Reference'];?></td>
                        <td><?php echo $row['Nom_Entreprise'];?></td>
                        <td>
                        <a href="update_entrée_matériel.php?id=<?php echo $row['ID_Materiel'];?>"><i class="fas fa-edit"></i></a>
                        <a href="delete_entrée_matériel.php?id=<?php echo $row['ID_Materiel'];?>"><i class="fas fa-trash-alt" ></i></a>
                        </td>
                        </tr>
               ...
               ?>
                <a href="form_matériel.php"><button type="button" class="btn btn-block btn-outline-info"><i class="fas fa-user-plus"></i></button></a>
                </div>
                <!-- /.card-body -->
              </div>
              <!-- /.card -->
