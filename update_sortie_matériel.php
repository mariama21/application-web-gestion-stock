...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $sortid = $_GET['id'];
    $getmateriel = mysqli_query($conn,"SELECT * FROM `sortie_stock` WHERE ID_Sortie_Stock='$sortid'");
    ...
    $getmateriel = mysqli_query($conn,"SELECT * FROM `materiel` WHERE ID_Materiel='$idgetMateriel'");
    
    $row2 = null;
    if(mysqli_num_rows($getmateriel) === 1){
        
        $row2 = mysqli_fetch_assoc($getmateriel);
    }
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="code_sortie_matériel.php" method='POST'>
                <div class="card-body">
                <div class="form-group">
                  <i class="fas fa-address-book"></i>
                  <label select>Materiel</label>
                  <select name="idMateriel"class="form-control">
                  <option value="<?php echo $row2['ID_Materiel'];?>"><?php echo $row2['Nom_Materiel'];?></option>
                  <?php
                 // require 'db_connection_utilisateur.php';
                  // function for getting data from database
                  $get_data = mysqli_query($conn,"SELECT * FROM `materiel`");
                  while($row3 = mysqli_fetch_assoc($get_data)){
                  ?>
                    <option value="<?php echo $row3['ID_Materiel'];?>"><?php echo $row3['Nom_Materiel'];?></option>
                     <?php
                    }
                  ?>
                </select>
                  ...
                  <i class="fas fa-newspaper"></i>
                    ...
                    <input type="text"  name='Demandeur' class="form-control" id="exampleInputEmail1" value="<?php echo $row['Demandeur'];?>">
                  </div>
                  <div class="form-group">
                  <i class="fas fa-cart-arrow-down"></i>
                    <label for="exampleInputEmail1">Quantite sortie</label>
                    <input type="number" name='Quantite_Sortie' class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo $row['Quantite_Sortie'];?>">
                  </div>
                  <div class="form-group">
                  <i class="fas fa-calendar-alt"></i>
                    <label for="exampleInputEmail1">Date Sortie</label>
                    <input type="date" name='Date_Sortie' class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo $row['Date_Sortie'];?>">
                  </div>
                ...
                <input type="hidden" name='sortid' id="sortid" value="<?php echo $row['ID_Sortie_Stock'];?>">
