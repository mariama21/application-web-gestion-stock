...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $user_id = $_GET['id'];
    $get_user = mysqli_query($conn,"SELECT * FROM `utilisateur` WHERE ID_Utilisateur='$user_id'");
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="form_update_utilisateur.php" method='POST'>
                <div class="card-body">
                  ...
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input type="text" name='Nom_Utilisateur'class="form-control" id="exampleInputEmail1" placeholder="Entrez votre nom" value="<?php echo $row['Nom_Utilisateur'];?>">
                  </div>
                  <div class="form-group">
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M2 2a2 2 0 0 1 2-2h5.293A1 1 0 0 1 10 .293L13.707 4a1 1 0 0 1 .293.707V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm7.5 1.5v-2l3 3h-2a1 1 0 0 1-1-1zM11 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm2 5.755S12 12 8 12s-5 1.755-5 1.755V14a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-.245z"/>
                    ...
                    <input type="text"  name='Prenom' class="form-control" id="exampleInputEmail1" placeholder="Entrez votre prénom"  value="<?php echo $row['Prenom'];?>">
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name='Login' class="form-control" id="exampleInputEmail1" placeholder="Entrez votre login"  value="<?php echo $row['Login'];?>">
                  </div>
                  <div class="form-group">
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-check-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                   <path fill-rule="evenodd" d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm9.854-2.854a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L12.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
                    ...
                    <input type="text" class="form-control" name='Statut' id="exampleInputEmail1" placeholder="Entrez votre statut"  value="<?php echo $row['Statut'];?>">
                  </div>
                  <div class="form-group">
                ...
                <input type="hidden" name='mot_de_passe' id="mot_de_passe" value="<?php echo $row['mot_de_passe'];?>">
