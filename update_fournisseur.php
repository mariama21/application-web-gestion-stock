...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $userid = $_GET['id'];
    $get_user = mysqli_query($conn,"SELECT * FROM `fournisseur` WHERE ID_Fournisseur='$userid'");
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="form_update_fournisseurs.php" method='POST' >
                <div class="card-body">
                  ...
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input type="Nom_Entreprise" name='Nom_Entreprise'class="form-control" id="exampleInputEmail1" placeholder="Entrez le nom" value="<?php echo $row['Nom_Entreprise']; ?>">
                  </div>
                  <div class="form-group">
                    ...
                    <input type="Pays" name='Pays'class="form-control" id="exampleInputEmail1" placeholder="Entrez le pays" value="<?php echo $row['Pays']; ?>">
                  </div>
                  <div class="form-group">
                    ...
                    <input type="Contact" name='Contact' class="form-control" id="exampleInputEmail1" placeholder="Entrez le contact"value="<?php echo $row['Contact']; ?>">
                  </div>
