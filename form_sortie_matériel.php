...
<body class="sidebar-mini layout-fixed sidebar-closed sidebar-collapse" style="height: auto;">
  <div class="wrapper">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="form_sortie_matériel.php" method='POST'>
                <div class="card-body">
                <div class="form-group">
                  <i class="fas fa-folder-open"></i>
                  <label select>materiels</label>
                  ...
                  ?>
                    <option value="<?php echo $row['ID_Materiel'];?>"><?php echo $row['Nom_Materiel'];?></option>
                     <?php
                    }
                  ?>
                </select>
                  ...
                  <i class="fas fa-newspaper"></i>
                    ...
                    <input type="text"  name='Demandeur' class="form-control" id="exampleInputEmail1" placeholder='Entrez le demandeur'>
                  </div>
                  <div class="form-group">
                  <i class="fas fa-cart-arrow-down"></i>
                    <label for="exampleInputEmail1">Quantite Sortie</label>
                    <input type="number" name='Quantite_Sortie' class="form-control" id="exampleInputEmail1" placeholder="">
                  </div>
                  <div class="form-group">
                  <i class="fas fa-calendar-alt"></i>
                    <label for="exampleInputEmail1">Date Sortie</label>
                    <input type="date" name='Date_Sortie' class="form-control" id="exampleInputEmail1" >
                  </div>
    ...
    if( !empty($_POST['Date_Sortie']) && !empty($_POST['Demandeur']) && !empty ($_POST['Quantite_Sortie']) && !empty($_POST['idmateriel']))
    {   
        ...
        $idUtilisateur = 4;
                ...
                $insert_query = mysqli_query($conn,"INSERT INTO `sortie_stock`(Date_Sortie,Demandeur,Quantite_Sortie,ID_Utilisateur,ID_Materiel)
                 VALUES('$Date_Sortie','$Demandeur','$Quantite_Sortie','$idUtilisateur','$idmateriel')");
